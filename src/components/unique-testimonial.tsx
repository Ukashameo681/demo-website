...
const testimonials = [
  {
    id: 1,
    quote: "They showed up within an hour on a Sunday during a heatwave. Fixed our AC fast and the price was exactly what they quoted. Highly recommended!",
    author: "Sarah Chen",
  ...
  {
    id: 2,
    quote: "We hired CoolAir Pro for a full central AC installation in our brownstone. From estimate to completion, everything was professional and on time.",
  ...
  {
    id: 3,
    quote: "Their maintenance plan has saved us thousands. Our system runs better than ever and the yearly check-up catches issues before they become problems.",
